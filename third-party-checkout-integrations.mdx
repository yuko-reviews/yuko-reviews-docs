...
| --------------------------------------------------------- | -------------------------------------------------------------- |
| Their current points balance                              | [`GET /customers/rewards/redeemable`](/get-redeemable-rewards) |
| Rewards available to redeem right now                     | [`GET /customers/rewards/redeemable`](/get-redeemable-rewards) |
| Spend their points to get a discount code or store credit | [`POST /customers/rewards/redeem`](/redeem-reward)             |
| Points they will earn on this purchase                    | [`POST /points/estimate`](/checkout-points-estimate)           |
