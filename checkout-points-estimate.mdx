...
```bash cURL
curl --request POST \
  --url "https://api.yukoapp.com/v1/public/points/estimate" \
...
const response = await fetch(
  "https://api.yukoapp.com/v1/public/points/estimate",
  {
    method: "POST",
    headers: {
...
```php PHP
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, "https://api.yukoapp.com/v1/public/points/estimate");
