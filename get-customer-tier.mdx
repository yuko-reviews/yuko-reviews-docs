...
```bash cURL
curl --request GET \
  --url "https://api.yukoapp.com/v1/public/tiers/customer?customer_id=9049402769586" \
...
const response = await fetch(
  `https://api.yukoapp.com/v1/public/tiers/customer?${params}`,
  {
    method: "GET",
    headers: {
...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, "https://api.yukoapp.com/v1/public/tiers/customer?{$query}");
