...
```bash cURL
curl --request GET \
  --url "https://api.yukoapp.com/v1/external/referral/program" \
  --header "Authorization: Bearer py_xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
```

```javascript JavaScript
const response = await fetch(
  "https://api.yukoapp.com/v1/external/referral/program",
  {
    method: "GET",
    headers: {
...
```php PHP
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, "https://api.yukoapp.com/v1/external/referral/program");
