...
<AccordionGroup>
  ...
  <Accordion title="Store Reviews (Testimonials)" icon="building-columns">
    ...
    **Best practices:**
    ...
    - Don't ask for store reviews in initial purchase emails
    - Wait until customer has 2-3 orders
    - Focus on service, shipping, overall experience
    - Use for homepage social proof

    **Expected volume:** 1-2% of visitors leave store reviews organically
  </Accordion>
...
<Tabs>
  <Tab title="Starting Out">
    ...
    **Setup:**
    ...
    4. ⏸️ Skip store reviews for now (focus on products)
  ...
  <Tab title="Growing Store">
    ...
    **Setup:**
    ...
    4. ✅ Add store review page (for testimonials)
    ...
    **Why this works:**
    ...
    - Store reviews diversify social proof
...
<Steps>
  ...
  <Step title="Enable Store Reviews (Optional)" icon="store">
    Collect overall testimonials about shopping experience, not tied to products.

    **Time:** 5 minutes → [Store Review Setup](/collect-reviews/collecting-store-reviews)
  </Step>
</Steps>
...
<Note>
  **Pro tip:** Start with product reviews first - they're the most valuable. Once you have 50+ product reviews, then add store reviews and custom fields. Don't overcomplicate the initial setup.
</Note>