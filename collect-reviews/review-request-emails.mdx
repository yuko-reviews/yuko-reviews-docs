...
<Frame>
  ![Yuko Review Request](/images/yuko-review-request.png)
</Frame>
...
<AccordionGroup>
  <Accordion title="Timing: When to Send" defaultOpen icon="calendar">
    **Setting:** Delay - Days after order fulfillment
    ...
    <img
      src="/images/yuko-review-request-setting.png"
      alt="Set Re"
      lightAlt="Set Re"
      darkAlt="Set Re"
  ...
  <Accordion title="Subject Line: First Impression" icon="envelope">
    ...
    **Best practices:**
    ...
    - How’s your order\_name?
    - customer\_first\_name, share your thoughts on your order
    - Quick question about your recent order
    - We’d love your feedback on order\_name
...
<Steps>
  ...
  <Step title="Match Your Brand" icon="palette">
    ...
    **Time:** 5 minutes
    ...
    → [Customize Email Branding](/display-reviews/branding)
  </Step>
