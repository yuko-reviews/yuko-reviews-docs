...
If you need to change markup, add JavaScript, or swap out the whole widget output, use the **[Plugin Hooks & Filters](/developer/plugin-hooks)** to modify plugin behaviour at the PHP layer.
