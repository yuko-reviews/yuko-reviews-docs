...
**POST /public/customers/\{customerId\}/rewards/redeem**
...
```bash cURL
curl --request POST \
  --url "https://api.yukoapp.com/v1/public/customers/9049402769586/rewards/redeem" \
  --header "Authorization: Bearer py_xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx" \
  --header "Content-Type: application/json" \
  --data '{ "reward_id": "90424fa7-e8a9-4ef4-b43a-72c9b2028db5" }'
```
...
const response = await fetch(
  `https://api.yukoapp.com/v1/public/customers/${customerId}/rewards/redeem`,
  {
    method: "POST",
    headers: {
...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, "https://api.yukoapp.com/v1/public/customers/{$customerId}/rewards/redeem");
